...
exports.handler = async (event) => {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      text: `Name: ${name}\nEmail: ${email}\nMessage: ${message}`,
      html: `
      <div style="margin: 0; padding: 20px; box-sizing: border-box; width: 100%; background-image: url(/public/Images/bg.jpg); background-size: cover;">
        <div style="margin: 0 auto; padding: 0; box-sizing: border-box; font-family: Arial, Helvetica, sans-serif; width: 80%;">
            <p style="display: flex; flex-direction: row; align-items: center; font-size: 24px; letter-spacing: 2px; font-weight: 600;"><img style="width: 75px; aspect-ratio: 1/1;" src="/public/Images/Logo-black.png" alt="Logo">Goldstern</p>
        </div>
        <div style="margin: 0 auto; padding: 0; box-sizing: border-box; font-family: Arial, Helvetica, sans-serif; width: 80%;">
